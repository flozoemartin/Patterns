...
* Creating supplementary table for patterns of prescribing paper - patterns of prescribing during pregnancy restricted to deliveries
...
* Table S6 - Patterns analysis restricted to delivery outcomes (live birth, stillbirth, live birth or stillbirth, delivery based on a third trimester record, delivery based on a late record).

********************************************************************************

* Start logging 

	log using "$Logdir\4_supplement\5_patterns in deliveries", name(patterns_in_deliveries) replace
...
*********************************************************************************
		...
		file open tablecontent using "$Tabledir\supp_patterns in deliveries.txt", write text replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close patterns_in_deliveries
	
	translate "$Logdir\4_supplement\5_patterns in deliveries.smcl" "$Logdir\4_supplement\5_patterns in deliveries.pdf", replace
	
	erase "$Logdir\4_supplement\5_patterns in deliveries.smcl"
