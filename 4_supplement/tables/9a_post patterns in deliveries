...
* Proportions who were and were not exposed to antidepressants in the 12 months after pregnancy in each discontinuation/no use group in deliveries
...
* Table S10 - Proportion of individuals who were prescribed antidepressants in the 12 months after pregnancy stratified by previous use, among deliveries (postnatal use)

*******************************************************************************

* Start logging 

	log using "$Logdir\4_supplement\9a_post patterns in deliveries", name(post_patterns_in_deliveries) replace
...
********************************************************************************
		...
		file open tablecontent using "$Tabledir\supp_post preg row pct deliveries.txt", write text replace
...
* Stop logging 
	...
	log close post_patterns_in_deliveries
	
	translate "$Logdir\4_supplement\9a_post patterns in deliveries.smcl" "$Logdir\4_supplement\9a_post patterns in deliveries.pdf", replace
	
	erase "$Logdir\4_supplement\9a_post patterns in deliveries.smcl"
