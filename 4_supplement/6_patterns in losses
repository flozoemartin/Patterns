...
* Creating supplementary table for patterns of prescribing paper - patterns of prescribing during pregnancy restricted to losses
...
* Table S7 - Patterns analysis restricted to loss outcomes (miscarriage, TOP, probable TOP, ectopic, molar, blighted ovum, unspecified loss).

********************************************************************************

* Start logging 

	log using "$Logdir\4_supplement\6_patterns in losses", name(patterns_in_losses) replace
...
*********************************************************************************
		...
		file open tablecontent using "$Tabledir\supp_patterns in losses.txt", write text replace
...
* Stop logging
	...
	log close patterns_in_losses
	
	translate "$Logdir\4_supplement\6_patterns in losses.smcl" "$Logdir\4_supplement\6_patterns in losses.pdf", replace
	
	erase "$Logdir\4_supplement\6_patterns in losses.smcl"
