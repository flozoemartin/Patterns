...
* Table 2 in patterns of prescribing paper is created by this script

********************************************************************************

* Start logging 

	log using "$Logdir\2_analysis\3_patterns table", name(patterns_table) replace
...
*********************************************************************************
		...
		file open tablecontent using "$Tabledir\long patterns table.txt", write text replace
...
* Stop logging, translate .smcl into .pdf and erase .smcl
	...
	log close patterns_table
	
	translate "$Logdir\2_analysis\3_patterns table.smcl" "$Logdir\2_analysis\3_patterns table.pdf", replace
	
	erase "$Logdir\2_analysis\3_patterns table.smcl"
